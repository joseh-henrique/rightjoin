    ...
    AddressPicker.prototype.get = function(query, cb) {
      ...
      return service.getPlacePredictions(this.options.autocompleteService, function(predictions) {
        ...
        data = (function() {
          ...
          _results = [];
          // JF 2014-4-20 Fix bug: Added the following line to account or get null-exception where no prediction was found.
          // Since the source is Coffeescript , this fix will be overwritten if and when we upgrade.   
          if (predictions==null) {
